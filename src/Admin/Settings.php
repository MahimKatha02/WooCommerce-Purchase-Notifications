...
class Settings {
	...
	public function add_settings_page() {
		add_submenu_page(
			'woocommerce',
			__( 'Purchase Notifications', 'antigravity-purchase-notifications' ),
			__( 'Purchase Notifications', 'antigravity-purchase-notifications' ),
			'manage_woocommerce',
			'wcpn-settings',
	...
	public function render_settings_page() {
		...
		<div class="wrap wcpn-admin-wrap">
			<div class="wcpn-dashboard-header">
				...
				<p class="wcpn-description"><?php esc_html_e( 'Display real-time recent order notifications to improve conversions using authentic shop data.', 'antigravity-purchase-notifications' ); ?></p>
			</div>
				...
				<div class="wcpn-dashboard-layout">
					...
					<div class="wcpn-sidebar">
						<ul class="wcpn-tabs">
							<li class="wcpn-tab-item active" data-tab="general">
								<span class="dashicons dashicons-admin-generic"></span> <?php esc_html_e( 'General Settings', 'antigravity-purchase-notifications' ); ?>
							</li>
							<li class="wcpn-tab-item" data-tab="display">
								<span class="dashicons dashicons-visibility"></span> <?php esc_html_e( 'Display Rules', 'antigravity-purchase-notifications' ); ?>
							</li>
							<li class="wcpn-tab-item" data-tab="privacy">
								<span class="dashicons dashicons-shield"></span> <?php esc_html_e( 'Privacy & GDPR', 'antigravity-purchase-notifications' ); ?>
							</li>
							<li class="wcpn-tab-item" data-tab="filters">
								<span class="dashicons dashicons-filter"></span> <?php esc_html_e( 'Product Filters', 'antigravity-purchase-notifications' ); ?>
							</li>
							<li class="wcpn-tab-item" data-tab="orders">
								<span class="dashicons dashicons-cart"></span> <?php esc_html_e( 'Order Filters', 'antigravity-purchase-notifications' ); ?>
							</li>
							<li class="wcpn-tab-item" data-tab="appearance">
								<span class="dashicons dashicons-art"></span> <?php esc_html_e( 'Appearance', 'antigravity-purchase-notifications' ); ?>
							</li>
						</ul>
						
						<div class="wcpn-actions">
							<?php submit_button( __( 'Save Settings', 'antigravity-purchase-notifications' ), 'primary wcpn-submit-btn' ); ?>
						</div>
					</div>
					...
					<div class="wcpn-content">
						...
						<div class="wcpn-tab-content active" id="tab-general">
							<div class="wcpn-card">
								<h2><?php esc_html_e( 'Core Configuration', 'antigravity-purchase-notifications' ); ?></h2>
								
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Enable Plugin', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Activate purchase notifications across product pages.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Device Compatibility', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper wcpn-checkbox-grid">
										<label>
											...
											<?php esc_html_e( 'Desktop', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											<input type="checkbox" name="wcpn_settings[general][enable_tablet]" value="1" <?php checked( $settings['general']['enable_tablet'], 1 ); ?>>
											<?php esc_html_e( 'Tablet', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											<input type="checkbox" name="wcpn_settings[general][enable_mobile]" value="1" <?php checked( $settings['general']['enable_mobile'], 1 ); ?>>
											<?php esc_html_e( 'Mobile', 'antigravity-purchase-notifications' ); ?>
										</label>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Notification Position', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									...
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Seconds to wait before showing the first notification card.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>
								...
								<div class="wcpn-field-row">
									...
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Seconds to show each notification card before shifting to the next.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Interactive Behaviors', 'antigravity-purchase-notifications' ); ?></label>
						...
						<div class="wcpn-tab-content" id="tab-display">
							<div class="wcpn-card">
								<h2><?php esc_html_e( 'Visible Fields & Custom Templates', 'antigravity-purchase-notifications' ); ?></h2>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Card Content Fields', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper wcpn-checkbox-list">
										<label>
											...
											<?php esc_html_e( 'Show Product Thumbnail', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											...
											<?php esc_html_e( 'Show Customer Name', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											...
											<?php esc_html_e( 'Show Customer Location', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											<input type="checkbox" name="wcpn_settings[display][show_quantity]" value="1" <?php checked( $settings['display']['show_quantity'], 1 ); ?>>
											<?php esc_html_e( 'Show Order Item Quantity', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											...
											<?php esc_html_e( 'Show Relative Time Ago', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											...
											<?php esc_html_e( 'Show Verified Purchase Badge', 'antigravity-purchase-notifications' ); ?>
										</label>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Notification Template', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description">
											<?php esc_html_e( 'Customize notification wording. Placeholders: ', 'antigravity-purchase-notifications' ); ?><br>
						...
						<div class="wcpn-tab-content" id="tab-privacy">
							<div class="wcpn-card">
								<h2><?php esc_html_e( 'GDPR Compliance & Data Obfuscation', 'antigravity-purchase-notifications' ); ?></h2>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'GDPR Anonymization Mode', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										<label class="wcpn-switch">
											<input type="checkbox" name="wcpn_settings[privacy][gdpr_mode]" value="1" <?php checked( $settings['privacy']['gdpr_mode'], 1 ); ?>>
											<span class="wcpn-slider"></span>
										</label>
										<span class="description"><?php esc_html_e( 'Strict GDPR compliance: all name anonymization and location processing is computed strictly server-side. No raw customer billing parameters are ever sent to the browser DOM.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Customer Name Privacy', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Choose how customer names are presented to website visitors.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Location Settings', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Location Fallback text', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										<input type="text" name="wcpn_settings[notification][customer_location_fallback]" value="<?php echo esc_attr( $settings['notification']['customer_location_fallback'] ?? __( 'Unknown Location', 'antigravity-purchase-notifications' ) ); ?>">
										<span class="description"><?php esc_html_e( 'Placeholder used if the customer location is missing.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Global Privacy Overrides', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper wcpn-checkbox-list">
										<label>
											<input type="checkbox" name="wcpn_settings[privacy][anonymous_mode]" value="1" <?php checked( $settings['privacy']['anonymous_mode'], 1 ); ?>>
											<?php esc_html_e( 'Anonymous Mode (Force "Someone" for all customer names)', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
										...
										<label>
											...
											<?php esc_html_e( 'Hide Purchase Relative Time', 'antigravity-purchase-notifications' ); ?>
										</label>
									</div>
								</div>
							</div>
						...
						<div class="wcpn-tab-content" id="tab-filters">
							<div class="wcpn-card">
								<h2><?php esc_html_e( 'Product Exclusions', 'antigravity-purchase-notifications' ); ?></h2>
								<p class="section-desc"><?php esc_html_e( 'Configure rules to block purchase popups on specific product pages.', 'antigravity-purchase-notifications' ); ?></p>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Exclude Product IDs', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Comma-separated list of WC Product IDs (e.g. 102, 154).', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Exclude Categories', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Comma-separated list of category slugs or IDs (e.g. shoes, shirts).', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Exclude Product Tags', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Comma-separated list of tag slugs or IDs.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Exclude Brands', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Comma-separated list of brand slugs or IDs.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Product Type Exclusions', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper wcpn-checkbox-list">
										<label>
											...
											<?php esc_html_e( 'Exclude Out of Stock Products', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											<input type="checkbox" name="wcpn_settings[filters][exclude_virtual]" value="1" <?php checked( $settings['filters']['exclude_virtual'], 1 ); ?>>
											<?php esc_html_e( 'Exclude Virtual Products', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											...
											<?php esc_html_e( 'Exclude Downloadable Products', 'antigravity-purchase-notifications' ); ?>
										</label>
									</div>
								</div>
							</div>
						...
						<div class="wcpn-tab-content" id="tab-orders">
							<div class="wcpn-card">
								<h2><?php esc_html_e( 'Order Eligibility Filters', 'antigravity-purchase-notifications' ); ?></h2>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Eligible Order Statuses', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper wcpn-checkbox-list">
										<?php
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Minimum Completed Orders', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'Only display purchase notifications if the store has at least X total orders.', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Safety Filter Overrides', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper wcpn-checkbox-list">
										<label>
											...
											<?php esc_html_e( 'Ignore Refunded Orders (Recommended)', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											...
											<?php esc_html_e( 'Ignore Failed Orders (Recommended)', 'antigravity-purchase-notifications' ); ?>
										</label>
										<label>
											...
											<?php esc_html_e( 'Ignore Cancelled Orders (Recommended)', 'antigravity-purchase-notifications' ); ?>
										</label>
									</div>
								</div>
							</div>
						...
						<div class="wcpn-tab-content" id="tab-appearance">
							<div class="wcpn-card">
								<h2><?php esc_html_e( 'Appearance & Styles Customizer', 'antigravity-purchase-notifications' ); ?></h2>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Animation Type', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Background Color', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Text Color', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Accent / Link Color', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Border Radius', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'e.g. 12px or 50%', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Border Style', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
										...
										<span class="description"><?php esc_html_e( 'e.g. 1px solid rgba(0,0,0,0.08) or none', 'antigravity-purchase-notifications' ); ?></span>
									</div>
								</div>

								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Shadow', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Padding', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Screen Margin Spacing', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Typography Font Family', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Font Size', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Notification Width', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Thumbnail Size', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
								...
								<div class="wcpn-field-row">
									<label class="wcpn-label"><?php esc_html_e( 'Custom CSS', 'antigravity-purchase-notifications' ); ?></label>
									<div class="wcpn-input-wrapper">
					...
					<div class="wcpn-preview-column">
						<div class="wcpn-sticky-preview-wrapper">
							<h3><?php esc_html_e( 'Live Cards Preview', 'antigravity-purchase-notifications' ); ?></h3>
							<p class="preview-desc"><?php esc_html_e( 'Shows styling customizations in real-time as configurations change.', 'antigravity-purchase-notifications' ); ?></p>
								...
								<div class="wcpn-card-preview" id="wcpn-card-preview-element">
									...
									<div class="wcpn-preview-body">
										...
										<div class="wcpn-preview-verified-badge" id="wcpn-preview-verified-element">
											...
											<span><?php esc_html_e( 'Verified Purchase', 'antigravity-purchase-notifications' ); ?></span>
										</div>
									</div>
							...
							<div class="wcpn-preview-controls">
								<button type="button" class="button button-secondary" id="wcpn-btn-animate-preview"><?php esc_html_e( 'Test Animation', 'antigravity-purchase-notifications' ); ?></button>
							</div>
						</div>
					</div>
				</div>
